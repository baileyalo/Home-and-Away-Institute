 ...
 * TakeTest.java
 *
 * Created on Nov 19, 2012, 12:39:53 PM
 */


import homeandawayinstituteprototype.TestRecord;
...
public class TakeTest extends javax.swing.JFrame {
    ...
    /** Creates new form TakeTest */ //create new test
    public TakeTest(Student ReStudent) {
        initComponents();
        currentStudent = ReStudent;
    ...
    private void initComponents() {
        ...
        jButton1.setAction(actionMap.get("DoTest")); // 
...
private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//event_jComboBox1ActionPerformed
    ...
    try {
        ...
        ArrayList< TestRecord> test = DatabaseLayer.getNewTest(currentStudent.getIdNumber(), ((customcombo) jComboBox1.getSelectedItem()).getValue());
    ...
    public void DoTest() {
        ...
        if (jList1.getSelectedIndex() != -1) {
            ...
            try {
                ...
                ArrayList<Question> questions = DatabaseLayer.getTestQuestions(
                        test.getTestid());
    ...
    private void reloadCourseTest() {
        ...
        try {
            ArrayList<CourseRecord> records = Coursedb.getCoursesBy(currentStudent.getProgramCode());
